const CACHE='boki1-v30';
const ASSETS=['./','./index.html','./manifest.webmanifest','./app.html','./patch.js','./mistake-explanation.js','./advanced-questions.js'];
